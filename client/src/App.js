...
// Defines a list of dicts storing data for individual info cards
const infoCards = [
  {
    icon: '🧬',
    title: 'What is Wolfram Syndrome?',
    subtitle: 'Key characteristics of the condition',
    description: 'Wolfram Syndrome is a rare genetic disorder characterized by juvenile-onset diabetes mellitus, optic nerve atrophy, and other neurological complications.'
  },
  {
    icon: '👨‍⚕️',
    title: 'Common Symptoms',
    subtitle: 'Major clinical manifestations',
    description: 'The condition typically presents with diabetes mellitus, vision problems, hearing loss, and various neurological issues that develop over time.'
  },
  {
    icon: '🧠',
    title: 'Genetic Factors',
    subtitle: 'Understanding the genetic basis',
    description: 'Mutations in the WFS1 gene, which provides instructions for making the wolframin protein, are the primary cause of Wolfram Syndrome.'
  },
  {
    icon: '🔬',
    title: 'Current Research',
    subtitle: 'Ongoing studies and findings',
    description: 'Researchers are actively studying the relationship between genetic variations and disease manifestations to develop targeted treatments.'
  }
];
  ...
  return (
    <div className="app">
      ...
      <header className="hero">
        <h1>Understanding Wolfram Syndrome</h1>
        <p className="subtitle">
          Explore the complex relationships between genetic factors and disease manifestations through our
          interactive visualization tool. Discover how different genetic variations may influence various aspects
          of Wolfram Syndrome.
        </p>
      ...
      <section className="visualization-section">
        <div className="visualization-header">
          ...
          <p className="subtitle">
            Adjust the genetic parameters below to see how they correlate with different disease manifestations.
          </p>
          <button
